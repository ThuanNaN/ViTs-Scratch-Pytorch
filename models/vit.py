...
class ViT(nn.Module):
    def __init__(self, *, image_size, patch_size, num_classes, \
        ...
        assert image_height % patch_size == 0 and images_width % patch_width == 0, \
                "Image dimensions must be divisible by the patch size."
        
        num_patches = (image_height // patch_height) * (images_width // patch_width)
        patch_dim = chanels * patch_height * patch_width
